...
class ZZTabItem {
  ...
  String? title;
  String? pic;
  ZZTabItem({required this.id, required this.title, required this.pic});
}
...
class ZZNestedScrollViewPageState extends State<ZZNestedScrollViewPage>
  ...
  Widget build(BuildContext context) {
    ...
    return ZZBaseScaffold(
      ...
      floatingActionButtonLocation: ZZFloatingActionButtonLocation(
        48.w,
        zzScreenHeight / 4.0,
      ),
      floatingActionButton:
          widget.scrollTop == true && showScrollTop
              ? FloatingActionButton(
                onPressed: () {
                  setState(() {
                    showScrollTop = false;
            ...
            if (widget.topWidgets != null) {
              return <Widget>[
                PullToRefreshContainer((
                  ...
                  return SliverToBoxAdapter(child: ZZPullToRefreshHeader(info));
                }),
  ...
  Widget? _tabbar() {
    ...
    if (widget.tabBarExtraHeight != null && _bar != null) {
      return Column(
        children: [
          SizedBox(width: 414.w, height: widget.tabBarExtraHeight!.value),
          widget.tabRightWidget == null
              ...
              : Row(
                children: [
                  ...
                  Container(child: widget.tabRightWidget),
                ],
              ),
        ],
      );
